...
Filigree is a lightweight, SQLite-backed issue tracker designed for AI coding agents (Claude Code, Codex, etc.) to use as first-class citizens. It exposes 112 MCP tools so agents interact natively, plus a full CLI for humans and background subagents.
...
- **MCP server** with 112 tools — agents interact natively without parsing text
...
| [MCP Server Reference](docs/mcp.md) | 112 MCP tools for agent-native interaction |
